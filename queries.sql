...
VALUES ('1122334455', 'Jane Doe', 5000, 'janeDoePass');

-- DELETE
-- Remove a stock entry
DELETE FROM Stocks
WHERE Company = 'Tesla Inc.';
...
FROM (SELECT Industry, AVG(Quantity) AS AvgQuantity
      FROM Investments
      GROUP BY Industry) SubQuery;
